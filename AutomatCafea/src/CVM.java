...
public class CVM {
    ...
    private void initialize() {
        ...
        frmCoffeeVendingMachin.setTitle("Automat de cafea");
        frmCoffeeVendingMachin.setBounds(300, 300, 600, 600);
        frmCoffeeVendingMachin.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frmCoffeeVendingMachin.getContentPane().setLayout(null);

        JLabel lblNewLabel = new JLabel("Automat de cafea");
        ...
        panel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Selectati bautura", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0, 0, 0)));
        panel.setBounds(59, 103, 450, 500);
        frmCoffeeVendingMachin.getContentPane().add(panel);
        panel.setLayout(null);

        espresso_RB = new JRadioButton("Espresso lung mare\u0142");
